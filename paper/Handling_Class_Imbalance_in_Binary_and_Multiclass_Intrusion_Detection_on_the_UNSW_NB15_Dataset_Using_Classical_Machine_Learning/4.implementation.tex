...
\hline
XGB & S0 & 0.769 & 0.509 & 0.727 & 0.963 \\
\textbf{XGB} & \textbf{S1} & 0.683 & \textbf{0.514} & \textbf{0.792} & 0.959 \\
...
\hline
Worms & 44 & 0.000 & 0.818 & $+\infty$ \\
Shellcode & 378 & 0.000 & 0.958 & $+\infty$ \\
Backdoor & 583 & 0.000 & 0.657 & $+\infty$ \\
Analysis & 677 & 0.000 & 0.177 & $+\infty$ \\
\hline
\end{tabular}
\end{table}
...
\begin{itemize}
    \item \textbf{Worms} (n=44): Recall increases from 0\% to 82\%, detecting 36 of 44 worm attacks.
    \item \textbf{Shellcode} (n=378): Near-perfect recall of 96\%, detecting 362 of 378 shellcode attacks.
    \item \textbf{Backdoor} (n=583): Recall of 66\%, detecting 383 of 583 backdoor attacks.
    \item \textbf{Analysis} (n=677): Modest recall of 18\%, though still infinitely better than the baseline.
\end{itemize}
